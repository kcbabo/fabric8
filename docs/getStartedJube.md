...
First you need to get the latest [Jube](jube.html) by [downloading jube-2.1.5-image.zip](http://central.maven.org/maven2/io/fabric8/jube/images/jube/jube/2.1.5/jube-2.1.5-image.zip) and unzipping it:
